...
class ErrorWindow extends Component {
  ...
  render() {
    if (this.props.errors.isError)
      return (
        <Modal isOpen={this.props.errors.isError} className="Modal__Bootstrap modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <button type="button" className="btn btn-primary" onClick={() => this.props.onCloseDialog()}>
                OK
              </button>
            </div>
          </div>
